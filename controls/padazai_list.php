<?php
	...
	include 'libraries/padazai.class.php';
	$padazaiObj = new padazai();
...
<table>
	...
	<?php
		...
		$elementCount = $padazaiObj->getPadazasListCount();

		// suformuojame sąrašo puslapius
		$paging->process($elementCount, $pageId);

		// išrenkame nurodyto puslapio klientus
		$data = $padazaiObj->getPadazasList($paging->size, $paging->first);
